...
export type ModelOptions = 'ada' | 'airochronos-33b' | 'babbage' | 'bing' | 'chatglm-2-6b' | 'claude-100k' | 'claude-2' | 'claude-2-100k' | 'claude-instant' | 'claude-instant-1' | 'code-llama-34b-instruct' | 'codellama-13b' | 'codellama-34b' | 'codellama-7b' | 'cohere' | 'curie' | 'davinci' | 'decilm-6b-instruct' | 'falcon-180b' | 'falcon-180b-chat' | 'flan-t5-xxl' | 'gpt-3.5-turbo' | 'gpt-3.5-turbo-0301' | 'gpt-3.5-turbo-0613' | 'gpt-3.5-turbo-16k' | 'gpt-3.5-turbo-16k-0301' | 'gpt-3.5-turbo-16k-0613' | 'gpt-4' | 'gpt-4-0314' | 'gpt-4-0613' | 'gpt-4-32k' | 'gpt-4-32k-0314' | 'gpt-4-32k-0613' | 'guanaco-33b' | 'idefics-80b' | 'inflection-1' | 'llama-2-13b' | 'llama-2-70b' | 'llama-2-70b-chat' | 'llama-2-7b' | 'llama2' | 'llava-13b' | 'mythomax-13b' | 'oasst-llama-2-13b' | 'oasst-llama-2-30b' | 'oasst-llama-2-70b' | 'oasst-pythia-12b' | 'oasst-pythia-2-12b' | 'oasst-sft-6-llama-30b' | 'palm' | 'palm-2' | 'qwen-7b' | 'solar-70b' | 'starchat-beta' | 'text-ada-001' | 'text-babbage-001' | 'text-curie-001' | 'text-davinci-001' | 'text-davinci-002' | 'text-davinci-003' | 'wizardcoder-34B' | 'wizardlm-13b' | 'wizardmath-13B' | 'wizardmath-7B' | 'you-chat';
